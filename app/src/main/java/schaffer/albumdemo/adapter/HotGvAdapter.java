...
public class HotGvAdapter extends MvcBaseAdapter<AlbumHomeBean.DataBean.HotDataBean> {


    public HotGvAdapter(Context ctx, List<AlbumHomeBean.DataBean.HotDataBean> list) {
        super(ctx, list);
    }
